...
<div align="center">
<h5> 🟢 Updated at: 2026-07-21 02:18:05 </h5>
</div>
...
دونالد ترامپ با انتشار پیامی در شبکه اجتماعی تروث سوشال از گفتگوی تلفنی «بسیار خوب» خود با اندی برنهام، نخست‌وزیر جدید بریتانیا خبر داد و اعلام کرد که دو طرف درباره «مین‌زدایی از تنگه هرمز» رایزنی کرده‌اند.
رئیس‌جمهوری ایالات متحده با اشاره به این گفتگو نوشت: «ما درباره موضوعات متعددی از جمله نفت دریای شمال، تجارت، اتحاد نظامی، مین‌زدایی از تنگه هرمز و بسیاری از مسائل دیگر گفتگو کردیم.»
ترامپ با تاکید بر روابط برجسته میان دو کشور افزود: «نخست‌وزیر وظیفه بزرگی پیش رو دارد، اما از عهده آن برخواهد آمد و البته آمریکا برای کمک در کنار او خواهد بود.» ترامپ همچنین اعلام کرد که دو طرف در آینده‌ای نزدیک برای گفتگو درباره موضوعات مورد علاقه مشترک با یکدیگر دیدار خواهند کرد.
@
VahidOOnLine
📡
@VahidOnline
